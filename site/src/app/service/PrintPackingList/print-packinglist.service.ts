...
export class PrintPackingListService {

  constructor(private http: HttpClient) { }
  EX_ContactCorp_Query(): Observable<any> {
    let url = `${environment.apiURL}PrintPackingList/EX_ContactCorp_Query`;
  ...
  EX_Config_Query(ItemType:any, ItemTypeName:any, ItemValue1:any, ItemValue2:any, ItemDesc:any, IsActive:any, IsMaintain:any, ActionFlag:any): Observable<any> {
    let url = `${environment.apiURL}PrintPackingList/EX_Config_Query?ItemType=${ItemType}&ItemTypeName=${ItemTypeName}&ItemValue1=${ItemValue1}&ItemValue2=${ItemValue2}&ItemDesc=${ItemDesc}&IsActive=${IsActive}&IsMaintain=${IsMaintain}&ActionFlag=${ActionFlag}`;
    let r = this.http.get<any>(url);
    return r;
  }
  EX_Goods_Packing_Query(PackingNo:any, GoodsNo:any, ActionFlag:any): Observable<any> {
    let url = `${environment.apiURL}PrintPackingList/EX_Config_Query?PackingNo=${PackingNo}&GoodsNo=${GoodsNo}&ActionFlag=${ActionFlag}`;
    let r = this.http.get<any>(url);
    return r;
  }
}
